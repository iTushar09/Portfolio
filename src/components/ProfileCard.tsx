...
const DEFAULT_BEHIND_GRADIENT =
  "radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(270,50%,20%,var(--card-opacity)) 4%,hsla(270,30%,15%,calc(var(--card-opacity)*0.75)) 10%,hsla(270,20%,10%,calc(var(--card-opacity)*0.5)) 50%,hsla(270,0%,5%,0) 100%),radial-gradient(35% 52% at 55% 20%,#14b8a640 0%,#073aff00 100%),radial-gradient(100% 100% at 50% 50%,#0f172a80 1%,#073aff00 76%),conic-gradient(from 124deg at 50% 50%,#a855f740 0%,#06b6d440 40%,#06b6d440 60%,#a855f740 100%)";

const DEFAULT_INNER_GRADIENT =
  "linear-gradient(145deg,rgba(15,23,42,0.8) 0%,rgba(168,85,247,0.2) 100%)";
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  miniAvatarUrl,
  name = "Tushar Chaudhri",
  title = "Electronics Engineer",
  handle = "Tusharchaudhari09",
  status = "Online",
  contactText = "Contact",
  showUserInfo = true,
  onContactClick,
