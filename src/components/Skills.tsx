...
const programmingLanguages: Skill[] = [
  { name: 'C', percentage: 90, icon: '⚡', color: 'from-blue-500 to-blue-600', proficiency: 'Advanced' },
  { name: 'C++', percentage: 85, icon: '🔧', color: 'from-purple-500 to-purple-600', proficiency: 'Advanced' },
  { name: 'Python', percentage: 80, icon: '🐍', color: 'from-yellow-500 to-green-500', proficiency: 'Advanced' },
  { name: 'JavaScript', percentage: 70, icon: '🚀', color: 'from-yellow-400 to-orange-500', proficiency: 'Intermediate' },
  { name: 'Assembly', percentage: 75, icon: '⚙️', color: 'from-gray-500 to-gray-600', proficiency: 'Intermediate' },
  { name: 'MATLAB', percentage: 78, icon: '📊', color: 'from-orange-500 to-red-500', proficiency: 'Advanced' },
];

const webDevelopment: Skill[] = [
  { name: 'HTML5', percentage: 85, icon: '🌐', color: 'from-orange-500 to-red-500', proficiency: 'Advanced' },
  { name: 'CSS3', percentage: 80, icon: '🎨', color: 'from-blue-500 to-purple-500', proficiency: 'Advanced' },
  { name: 'TypeScript', percentage: 68, icon: '📘', color: 'from-blue-600 to-blue-700', proficiency: 'Intermediate' },
  { name: 'Bootstrap', percentage: 75, icon: '🅱️', color: 'from-purple-600 to-indigo-600', proficiency: 'Intermediate' },
  { name: 'Tailwind CSS', percentage: 82, icon: '💨', color: 'from-teal-400 to-cyan-500', proficiency: 'Advanced' },
];
...
const Skills: React.FC = () => {
  return (
    <section id="skills" className="py-20 bg-gradient-to-b from-black/30 to-black/10 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white">
            Technical <span className="bg-gradient-to-r from-purple-400 to-teal-400 bg-clip-text text-transparent">Skills</span>
          </h2>
          ...
          <div className="mt-12 bg-gradient-to-br from-black/40 to-black/20 p-8 rounded-2xl border border-teal-900/30 backdrop-blur-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {webDevelopment.map((skill, index) => (
                <div key={index} className="group px-5 py-4 bg-gradient-to-r from-black/60 to-teal-900/20 rounded-xl border border-teal-500/30 text-teal-300 hover:border-teal-400/60 hover:from-black/80 hover:to-teal-900/40 transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
                  <div className="flex flex-col items-center gap-3">
                    <div className="text-4xl group-hover:scale-110 transition-transform">
                      {skill.icon}
                    </div>
                    <div className="text-center">
                      ...
                      <div className="text-xs text-teal-400 mt-1">
                        {'★'.repeat(Math.round(skill.percentage / 20)) + '☆'.repeat(5 - Math.round(skill.percentage / 20))}
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="mt-12 text-center">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="bg-gradient-to-br from-purple-900/30 to-purple-800/20 p-6 rounded-xl border border-purple-500/20">
                <div className="text-3xl font-bold text-purple-400 mb-2">{programmingLanguages.length}</div>
              ...
              <div className="bg-gradient-to-br from-teal-900/30 to-teal-800/20 p-6 rounded-xl border border-teal-500/20">
                <div className="text-3xl font-bold text-teal-400 mb-2">{webDevelopment.length}</div>
              ...
              <div className="bg-gradient-to-br from-pink-900/30 to-pink-800/20 p-6 rounded-xl border border-pink-500/20">
                <div className="text-3xl font-bold text-pink-400 mb-2">{softSkills.length}</div>
